 ...
 *
 * ไม่จำกัดช่วงเวลา — เช็คอิน/เช็คเอาท์ได้ตลอด 24 ชั่วโมง
 * (รองรับกะกลางคืน, OT ดึก, และตารางงานยืดหยุ่น)
 */
function validateSlotTiming(slot, config) {
  // No time restrictions — allow check-in/out at any time of day
  return null;
}
